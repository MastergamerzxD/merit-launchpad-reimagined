...
export default function CTASection() {
  return (
    <section className="py-3 md:py-4 bg-gradient-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-2 animate-fade-in">
            <Zap className="h-4 w-4" />
            <span className="text-sm font-medium">Start Your Journey Today</span>
          </div>

          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-3 animate-fade-in-up leading-tight" style={{ animationDelay: "0.1s" }}>
            Ready to Launch Your Merit?
          </h2>

          <p className="text-base md:text-lg mb-4 text-white/90 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          ...
          {/* Benefits List */}
          <div className="grid md:grid-cols-3 gap-3 mb-4 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 animate-fade-in-up mb-4" style={{ animationDelay: "0.4s" }}>
            <Button 
              size="lg" 
              variant="secondary"
          ...
          {/* Stats Grid */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 pt-4 border-t border-white/20 animate-fade-in-up" style={{ animationDelay: "0.5s" }}>
