...
export default function SuccessStoriesSection() {
  return (
    <section className="py-3 md:py-4 bg-background relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-6 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-2 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
              Join <span className="bg-gradient-primary bg-clip-text text-transparent">50,000+ Students</span> Who Achieved Their Dreams
            </h2>

            <p className="text-base text-muted-foreground mb-4 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
